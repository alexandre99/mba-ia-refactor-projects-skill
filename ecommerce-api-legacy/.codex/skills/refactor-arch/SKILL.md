...
2. Include deprecated API detection based on installed dependency versions and official migration signals available in the repository.
...
Report detected stack/domain, audit path/counts, files changed, architecture boundaries, validation commands/outcomes, intentional contract changes, and unresolved risks.